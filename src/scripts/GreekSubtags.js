// src/scripts/GreekSubtags.js
import fs from "fs";
import sqlite3 from "sqlite3";
import * as paths from "./modules/paths.js";

const SOURCE_DB_PATH = paths.GREEK_ENCODED_DB;
const TARGET_DB_PATH = paths.GREEK_ALIGNED_DB;
...
function resetOutputDatabase() {
  ...
  console.log("Reset greek_aligned.db");
}
...
main().catch((err) => {
  console.error("GreekSubtags failed:", err);
  process.exitCode = 1;
});
